...
function calculateGradeNeeded(){
    ...
    if(desire.length > 0 && weight > 0){
        ...
        alert("You need to enter the grade that you want and the weight that it has.");
    }
...
function calculateCurrentGrade(){
    ...
    if(totalWeight === 100 && cat1.length > 1 && cat1weight > 0){
        ...
        alert(" You need to make sure that the total weight is equal to 100 and both the points and weight are filled in.");
    }
}
...
function addRow() {
    if(count <= 4){
        ...
        if(catName.length >= 1){
            ...
            alert("You need to enter a category name");
        }


    }else{
        alert("You have too many categories. You need to refresh the page to restart grade calculator.");
    }
}